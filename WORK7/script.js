...
/* осуществляем подсчет очков */
function pointReaders () {
    const addingPoints = document.querySelector(".score");
    let points =`<span id="score-value" class="value">${score}</span>`;
    addingPoints.innerHTML = points;
